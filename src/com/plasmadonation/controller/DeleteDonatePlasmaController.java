...
/*
 * Delete Donate Plasma Request Controller
 */
@WebServlet("/deletedonateplasma")
public class DeleteDonatePlasmaController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for (int i = 0; i < emails.length; i++) {
			success = success + donarPlasmaDAO.deleteDonarRequest(emails[i]);
		}
		...
		if (success == emails.length) {
			...
			RequestDispatcher requestDispatcher = req.getRequestDispatcher("DonarPlasmaList.jsp");
