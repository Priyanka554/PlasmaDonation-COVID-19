...
<link rel="stylesheet" href="RequestPlasma.css">
</head>
<body>
...
<!-- Side Navigation bar -->
 ...
 <div class="row">
  ...
  <li><a class="link active" href="#">Request Plasma</a></li>
...
<div class="container form-style">
 ...
 <div class="row table">
  ...
  <div class="row table">
    <div class="col-sm-6 form-group">
     <label for="date">Date of First Symptom</label>
     <input type="date" id="date" class="form-control" name="firstSymptomDate" required="required">
    </div>
  </div>
  <div class="row table">
  <div class="col-sm-8 form-group">
 <label class="symptom-lable">Symptoms</label> &nbsp;
 <div>
    <div class="form-check-inline" style="padding-top: 15px">
  <label class="form-check-label checkbox-input" required="required">
    <input type="checkbox" class="form-check-input" name="symptoms" value="fever"> &nbsp; Fever
  </label>
</div>
<div class="form-check-inline" style="padding-top: 15px">
  <label class="form-check-label checkbox-input ">
    <input type="checkbox" class="form-check-input" name="symptoms" value="drycough"> &nbsp; dry cough
  </label>
</div>
<div class="form-check-inline" style="padding-top: 15px">
  <label class="form-check-label ">
    <input type="checkbox" class="form-check-input" name="symptoms" value="tiredness"> &nbsp; tiredness
  </label>
</div>
  </div>
  </div>
